...
use App\Entity\PdfGeneratorServicee;
use Knp\Component\Pager\PaginatorInterface;
use App\Service\MailerService; 
use Symfony\Component\Mime\Emailll;
...
if($request->isMethod("POST")){
    ...
    #[Route('/pdf/evenement', name: 'generator_servicee')]
    ...
    { 
        ...
        $pdfGeneratorServicee=new PdfGeneratorServicee();
        $pdf = $pdfGeneratorServicee->generatePdf($html);
